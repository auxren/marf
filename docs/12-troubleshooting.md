...
**The Pulse 1 switch/jack programs or outputs Pulse 2 (or the LEDs are reversed).**
Some units have the Pulse 1/2 LEDs and/or the pulse channel (switches + output
jacks) reversed. Recalibrate and use the optional pulse **LED swap** and/or pulse
**channel swap** steps ([Calibration](03-calibration.md#procedure)) — they are
independent, so set whichever your unit needs. The channel swap fixes the
switches and output jacks together.
