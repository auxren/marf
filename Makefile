...
DEFINES = -DSTM32F40XX -DSTM32F4XX -DUSE_STDPERIPH_DRIVER -DMARF_HW=$(MARF_HW) \
  ...
  -DBUS200E_RXLOG_ONLY=$(BUS200E_RXLOG_ONLY) -DBUS200E_FORENSIC=$(BUS200E_FORENSIC) -DBUS200E_NO_ACK=$(BUS200E_NO_ACK) -DBUS200E_COOP_ACK=$(BUS200E_COOP_ACK) -DBUS200E_VERIFY_WRITES=$(BUS200E_VERIFY_WRITES) \
